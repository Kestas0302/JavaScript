...
// const arowwMinutesToSeconds = (minutes) => {
//     const seconds = minutes * 60;
//     return `${seconds} seconds`
// } ;

// const arowwMinutesToSeconds1 = (minutes) => minutes * 60 + " seconds";
// const arowwMinutesToSeconds2 = (minutes) => `${minutes*60} seconds`;
// console.log(arowwMinutesToSeconds(3));
...
// const triangleArre = (x,y) => (x * y) / 2;
// console.log(triangleArre(5,4));

// 5 pratimas

// const lastChar = (string) => string.charAt(string.length - 1);
// console.log(lastChar("Kestutis"));
