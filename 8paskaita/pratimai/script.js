...
document.addEventListener("input", convertToFarenheit);
...
document.addEventListener("submit", handleFormSubmit1);
...
document.querySelectorAll("form"[5]);
document.addEventListener("submit", handleFormSubmit2);
...
document.querySelectorAll("form"[6]);
document.addEventListener("submit", drawTriangle);
